public abstract class Monster implements ElementalAttacks {
    ...
    public boolean equals(Monster other) {
        return this.name.equals(other.getName()) && this.element.equals(other.getElement())
                && this.health == other.getHealth() && this.attack == other.getAttack()
                && this.defense == other.getDefense() && this.speed == other.getSpeed();
    }
