...
public class ScannerTest {
    public static void main(String[] args) {
        ...
        System.out.println("(true/false) Will you vote to make mangos mandatory for breakfast every day?");

        boolean lovesMangos = keyboard.nextBoolean();

        while (lovesMangos == false) {
            System.out.println("Again... You VOTE to make mangos mandatory every day. (true/false)");
