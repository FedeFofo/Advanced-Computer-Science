...
public class DebugDemoStudent {
    ...
    public static int getStringLength(String str) {
        if (str == null) {
            throw new NullPointerException("It's impossible to find the length of a null string.");
        }
    ...
    public static double averageScore(int[] scores) {
        ...
        if (scores == null) {
            throw new IllegalArgumentException("It's impossible to find the average of a null array.");
        }
    ...
    public static int squareRootFloor(int n) {
        if (n < 0) {
            throw new IllegalArgumentException("It is impossible for a negative number to be square rooted (unless using i)");
        }
    ...
    public static String slice(String word, int start, int end) {
        if (word == null) {
            throw new IllegalArgumentException("It is impossible to silence unhappy people.");
        }

        if (start < 0 || end >= word.length()) {
            throw new IllegalArgumentException("The start and/or end numbers are outside of the range of the word.");
        }
